            ...
            <div className="max-w-[555px] h-[570px] bg-white m-auto px-14 py-10 rounded-md">
                ...
                {state === "Sign Up" ? (
                    <p className="text-black font-bold">
                        ...
                        <span onClick={() => setState("Login")} className="text-[#b57b65] underline cursor-pointer"> Login</span>
                    </p>
                ) : (
                    <p className="text-black font-bold">
                        Create an account.{" "}
                        <span onClick={() => setState("Sign Up")} className="text-[#b57b65] underline cursor-pointer"> Sign Up</span>
                    </p>
                )}
